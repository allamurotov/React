export default function Anons() {
    return <div className="ml-5 flex flex-col items-start relative w-full p-4  bg-[#0B4789] overflow-hidden rounded-[8px]">
        ...
        <button className="flex items-center justify-center gap-2 w-[149px] bg-[#1C92E0] text-[16px] text-white py-2 px-5 font-poppins font-[500] h-[40px] cursor-pointer hover:bg-[#1676b5] transition-colors mt-2 rounded-[8px]">Batafsil<img src="/Vector%20(Stroke).svg" alt="img" /></button>
    </div>
}
